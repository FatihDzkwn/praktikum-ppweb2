...
<body>
    <div class="container mt-5">
        ...
        <p>Silahkan isi buku tamu yang terletak dibawah ini</p>
        ...
        <form method="POST" action="kunjungan.php">
            ...
            <div class="form-group row">
                ...
                <span id="emailHelpBlock" class="form-text text-muted">Isi Email aktif kamu</span>
                </div>
            </div>
            <div class="form-group row">
                <label for="message" class="col-4 col-form-label">Keperluan</label> 
                <div class="col-8">
                <textarea id="message" name="message" cols="40" rows="5" required="required" class="form-control" aria-describedby="messageHelpBlock"></textarea> 
                <span id="messageHelpBlock" class="form-text text-muted">Silahkan isikan keperluan kamu mengunjungi perpustakaan</span>
                </div>
            </div> 
            <div class="form-group row">
